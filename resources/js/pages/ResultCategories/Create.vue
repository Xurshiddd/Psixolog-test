...
const submitForm = () => {
    ...
    router.post('/result-categories', form.value, {
...
<template>
    <Head title="Yangi Result Category" />
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">
                    Test natijalari uchun yangi kategoriya yarating
                </p>
            </div>
                ...
                <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            :disabled="!form.module_id || loadingValues"
                    ...
                    <div class="flex gap-3 pt-4">
                        ...
                        <button
                            type="button"
                            @click="router.visit('/result-categories')"
